  ...
  Workmanager().executeTask((taskName, inputData) async {
    ...
    try {
      ...
      final databaseMaintenanceService =
          DatabaseMaintenanceService(appDatabase: appDatabase);
      final dataCleanupService = DataCleanupService(appDatabase: appDatabase);
      final deviceInfoService =
          DeviceInfoService(); // DeviceInfoService is simple enough to initialize directly
      ...
      String username = inputData?['username'] ??
          'unknown_user'; // Username should ideally come from persisted login state
