// lib/presentation/screens/document_online/am_checksheet_online_viewmodel.dart
import 'package:flutter/material.dart';
import 'package:biochecksheet7_flutter/data/database/app_database.dart';
import 'package:biochecksheet7_flutter/data/repositories/document_record_online_repository.dart';

class AMChecksheetOnlineViewModel extends ChangeNotifier {
  final DocumentRecordOnlineRepository _repository;

  AMChecksheetOnlineViewModel({required DocumentRecordOnlineRepository repository})
