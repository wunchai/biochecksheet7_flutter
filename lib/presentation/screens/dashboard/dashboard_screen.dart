                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.all(
                        16.0), // Padding around the message text.
                    child: Text(
                      viewModel
                          .message, // Display a message or status from the ViewModel.
                  ...
                  Expanded(
                    ...
                    child: viewModel.isLoading
                        ? const Center(
                            child:
                                CircularProgressIndicator()) // Show loading spinner if data is loading.
                        : ListView.builder(
                            itemCount: viewModel.dashboardItems
                                .length, // Number of items in the list.
                            padding: const EdgeInsets.symmetric(
                                horizontal: 8.0,
                                vertical: 4.0), // Padding for the entire list.
                            itemBuilder: (context, index) {
                              final item = viewModel.dashboardItems[
                                  index]; // Get the current dashboard item.
                              ...
                              return Card(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () {
                                    ...
                                    print(
                                        'Dashboard Item Tapped: ${item.content}');
                                  },
                                  child: Padding(
                                    padding: const EdgeInsets.all(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: Theme.of(context)
                                              .textTheme
                                              .bodySmall, // Smaller text style for details.
                                        ),
                                      ],
                                    ),
                                  ),
