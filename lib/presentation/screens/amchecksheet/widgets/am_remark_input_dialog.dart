...
class AmRemarkInputDialogContent extends StatefulWidget {
  // Keeping StatefulWidget for potential future internal state
  // CRUCIAL CHANGE: Accept TextEditingController from outside
  final TextEditingController controller;

  const AmRemarkInputDialogContent({
    super.key,
    required this.controller, // Require the controller to be passed
  });

  @override
  State<AmRemarkInputDialogContent> createState() =>
      _AmRemarkInputDialogContentState();
}

class _AmRemarkInputDialogContentState
    extends State<AmRemarkInputDialogContent> {
