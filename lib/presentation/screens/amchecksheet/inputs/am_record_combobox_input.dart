...
class AmRecordComboBoxInputField extends StatefulWidget {
  ...
  const AmRecordComboBoxInputField({
    super.key,
  ...
  @override
  State<AmRecordComboBoxInputField> createState() =>
      _AmRecordComboBoxInputFieldState();
}

class _AmRecordComboBoxInputFieldState
    extends State<AmRecordComboBoxInputField> {
  ...
  @override
  void didUpdateWidget(covariant AmRecordComboBoxInputField oldWidget) {
