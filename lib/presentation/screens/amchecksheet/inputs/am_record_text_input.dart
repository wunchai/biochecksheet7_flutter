...
class AmRecordTextInputField extends StatefulWidget {
  ...
  @override
  State<AmRecordTextInputField> createState() => _AMRecordTextInputFieldState();
}

class _AMRecordTextInputFieldState extends State<AmRecordTextInputField> {
  @override
  void initState() {
    super.initState();
  ...
  @override
  void didUpdateWidget(covariant AmRecordTextInputField oldWidget) {
