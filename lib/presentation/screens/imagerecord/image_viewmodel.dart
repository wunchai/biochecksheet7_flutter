...
class ImageViewModel extends ChangeNotifier {
  ...
  Future<void> loadImages({
    ...
    try {
      print(
          'ImageViewModel.loadImages: Loading images for DocID=$documentId, MachineID=$machineId, JobID=$jobId, TagID=$tagId, ProblemID=$problemId'); // <<< Debugging
 ...
 // Check if problemId is needed for this context (if coming from ProblemScreen)
    ...
    */
    ...
    try {
      ...
      print(
          'ImageViewModel._processAndSaveImage: Saving image with ProblemID: "${_problemId}"'); // <<< Debugging
