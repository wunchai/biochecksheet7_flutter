...
class _HomeAppBarState extends State<HomeAppBar> {
  ...
  Widget build(BuildContext context) {
    final viewModel = Provider.of<HomeViewModel>(context); // Listen to ViewModel changes.
    ...
    return AppBar(
      ...
      title: _isSearching
          ? TextField(
              ...
              onChanged: (value) {
                viewModel.setSearchQuery(value); // Call ViewModel's setSearchQuery
              },
              autofocus: true,
            )
          : Text(widget.title),
        ...
        IconButton(
          ...
          onPressed: () {
            setState(() {
              ...
              if (!_isSearching) {
                widget.searchController.clear(); // Clear search text when closing
